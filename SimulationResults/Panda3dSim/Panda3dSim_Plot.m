...
% n = 0;
% traj_plan = traj_plan(89-n*4:92-n*4,:);
% num = 4;
% for i  = 1:4
%    traj = traj_plan(i,:);
%    y = [traj(1:2:40)+2];
...
% n = 2;
% traj_plan = traj_plan(89-4*n:92-4*n,:);
% num = 4;
% for i  = 1:num
%    traj = traj_plan(i,:);
%    y = [traj(1:2:40)-2];
...
n = 4;
traj_plan = traj_plan(97-n*2:98-n*2,:);
num = 2;
for i  = 1:num
   traj = traj_plan(i,:);
   y = [traj(1:2:40)+2];
...
% load('traj_plan_platoon.mat');
% n = 4;
% traj_plan = traj_plan(45:20:45+20*n,:);
% for i  = 1:n
%    traj = traj_plan(i,:);
%    if i == 1
%           y = [traj(1:2:40)+2];
